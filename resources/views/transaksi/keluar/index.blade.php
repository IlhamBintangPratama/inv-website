            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="{{ url('keluar')}}">Barang Keluar</a></li>
              ...
              <table class="table align-items-center table-flush">
                ...
                @foreach($outs as $no => $out)
                  <tr>
                    ...
                    <th scope="row">
                      <div class="media align-items-center">
                        <div class="media-body">
                          <span class="name mb-0 text-sm">{{ $out->nm_brg }}</span>
                        </div>
                      </div>
                    </th>
                    <td class="budget">
                    ...
                    <td class="budget">
                      {{ ($out->kategori == 1) ? 'Box Packing' : 'Plain Packing' }}
                    </td>
                    <td>  
                        <a href="{{ url('/keluar/'.$out->id.'/edit') }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                        <a href="{{ url('/keluar/'.$out->id.'/show') }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach
                </tbody>
