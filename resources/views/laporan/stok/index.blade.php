    ...
    <div class="header-body">
        ...
        <div class="col-lg-6 col-7">
            ...
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item"><a href="{{ url('laporan-stok')}}">Lap. Stok Gudang</a></li>
    ...
    <div class="col">
        ...
        <div class="table-responsive">
            ...
            <thead class="thead-light">
                ...
                <th scope="col" class="sort" data-sort="name">Awal</th>
                <th scope="col" class="sort" data-sort="name">Masuk</th>
                <th scope="col" class="sort" data-sort="name">Keluar</th>
                <th scope="col" class="sort" data-sort="name">Akhir</th>
                </tr>
            </thead>
            <tbody class="list">
            @foreach($lapstok as $no => $laps)
                <tr>
                <td>{{ $lapstok->firstItem()+$no}} </td>
                <td class="budget">
                    {{ $laps->tanggal }}
                </td>
                <th scope="row">
