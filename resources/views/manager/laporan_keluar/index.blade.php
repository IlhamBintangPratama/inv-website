...
<nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <!-- Search form -->
        <form action="{{ url('search-lap-keluar')}}" class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" method="GET">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link pr-0" href="/dashboard" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="header-body">
        ...
        <div class="col-lg-6 col-7">
            ...
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item"><a href="{{ url('laporan-keluar')}}">Laporan Keluar</a></li>
        ...
        <div class="row mt-4" >
            {{-- <div class="col" style="width: 100%"> --}}
                <form action="{{ url('laporan-keluar/periode1')}}" method="get" class="form-inline">
...
<div class="container-fluid mt--6">
    ...
    <div class="col">
        ...
        <div class="card-header border-0">
            <h3 class="mb-0">Laporan Keluar</h3>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content" style="width: 330px;">
                        ...
                        <form action="{{ url('laporan-keluar/periode')}}" method="get" class="form-inline">
                            <div class="box-body">
                                ...
                                <div class="form-group" style="margin-left: 20px; margin-top: 20px;">
                                    ...
                                    <a href="" onclick="this.href='{{url('cetak-laporan-keluar')}}/'+document.getElementById('tglawal').value + '/' +document.getElementById('tglakhir').value" 
        ...
        <div class="table-responsive">
            ...
            <tbody class="list">
            @foreach($out_report as $no => $laps)
                <tr>
                <td>{{ $out_report->firstItem()+$no}} </td>
                <td class="budget">
                    {{ $laps->tanggal }}
                </td>
                <th scope="row">
                    ...
                    <div class="media-body">
                        <span class="name mb-0 text-sm">{{ $laps->buyer }}</span>
                    </div>
                    </div>
                </th>
                <td class="budget">
                ...
                <td class="budget">
                    {{ ($laps->kategori == 1) ? 'Box Packing' : 'Plain Packing' }}
                </td>
                <td class="budget">
