...
'use strict';
(function (W, L) {
    "object" === typeof module && module.exports ? (L["default"] = L, module.exports = W.document ? L(W) : L) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function () {
        return L(W)
    ...
    L(a, "Core/Utilities.js", [a["Core/Globals.js"]], function (a) {
        ...
        function A(b, d) {
            var D = {};
            J(b, function (g, k) {
                if (I(b[k], !0) && !b.nodeType && d[k]) g = A(b[k], d[k]), Object.keys(g).length && (D[k] = g);
        ...
        function c(b, d, g) {
            var k;
            x(d) ? f(g) ? b.setAttribute(d, g) : b && b.getAttribute && ((k = b.getAttribute(d)) || "class" !== d || (k = b.getAttribute(d +
                "Name"))) : J(d, function (d, g) {
                b.setAttribute(g, d)
            });
            return k
        }
        ...
        function K(b, d, g) {
            ...
            function r(g) {
                ...
                if (b.nodeName) {
                    ...
                    J(Q, function (b, d) {
                        if (g[d])
                            for (y = g[d].length; y--;) k(d, g[d][y].fn)
                    })
                }
            }
        ...
        u = function () {
            ...
            u.prototype.get = function (a) {
                ...
                if ("undefined" !== typeof this.stops) {
                    ...
                    n && v(n[0]) ? "rgb" === a || !a && 1 === n[3] ? "rgb(" + n[0] + "," + n[1] + "," + n[2] + ")" : "a" === a ? n[3] : "rgba(" + n.join(",") + ")" : E;
                return h
            };
            u.prototype.brighten = function (a) {
                ...
                if (this.stops) this.stops.forEach(function (h) {
                    ...
                    for (E = 0; 3 > E; E++) n[E] += x(255 * a), 0 > n[E] && (n[E] = 0), 255 < n[E] && (n[E] = 255);
                return this
            };
            ...
            u.prototype.tweenTo = function (a, E) {
                var n = this.rgba,
                    h = a.rgba;
                h.length && n && n.length ? (a = 1 !== h[3] || 1 !== n[3], E = (a ?
                    "rgba(" : "rgb(") + Math.round(h[0] + (n[0] - h[0]) * (1 - E)) + "," + Math.round(h[1] + (n[1] - h[1]) * (1 - E)) + "," + Math.round(h[2] + (n[2] - h[2]) * (1 - E)) + (a ? "," + (h[3] + (n[3] - h[3]) * (1 - E)) : "") + ")") : E = a.input || "none";
                return E
            };
            u.names = {
                white: "#ffffff",
    ...
    L(a, "Core/Time.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u) {
        ...
        u = function () {
            ...
            w.prototype.dateFormat = function (c, l, e) {
                ...
                n(t,
                    function (b, d) {
                        for (; - 1 !== c.indexOf("%" + d);) c = c.replace("%" + d, "function" === typeof b ? b.call(q, l) : b)
                    });
            ...
            w.prototype.getTimeTicks = function (c, l, t, h) {
                ...
                if (G(l)) {
                    ...
                    l = k.getTime();
                    for (k = 1; l < t;) p.push(l), l = b === e.year ? q.makeTime(F + k * g, 0) : b === e.month ? q.makeTime(F, h + k * g) : !r || b !== e.day && b !== e.week ? r && b === e.hour && 1 < g ? q.makeTime(F, h, D, m + k * g) : l + b * g : q.makeTime(F, h, D + k * g * (b === e.day ? 1 : 7)), k++;
                    p.push(l);
                    b <= e.hour && 1E4 > p.length && p.forEach(function (b) {
                        0 === b % 18E5 && "000000000" === q.dateFormat("%H%M%S%L",
                            b) && (d[b] = "day")
                    })
                }
                p.info = B(c, {
                        ...
                        if (h.length === a.length && 1 > f)
                            for (var e = 0; e < a.length; e++) {
                                for (var t = h[e], m = a[e], w = [], q = 0; q < m.length; q++) {
                                    var l = t[q],
                                        J = m[q];
                                    B(l) && B(J) && ("A" !== m[0] || 4 !== q && 5 !== q) ? w[q] = l + f * (J -
                                        l) : w[q] = J
                                }
                                c.push(w)
                            } else c = a;
    ...
    L(a, "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u) {
        ...
        u = function () {
            ...
            c.filterUserAttributes =
                function (e) {
                    n(e, function (a, f) {
                        var h = !0; - 1 === c.allowedAttributes.indexOf(f) && (h = !1); - 1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(f) && (h = E(a) && c.allowedReferences.some(function (c) {
        ...
        a = function () {
            ...
            a.prototype.css = function (b) {
                ...
                if (a) {
                    ...
                    if (b)
                        ...
                        else if ("text" === k.nodeName.toLowerCase() && b.width) var H = this.textWidth =
                        C(b.width);
                    this.styles = b;
            ...
            a.prototype.getBBox = function (d, g) {
                ...
                var N =
                    ...
                    f;
                if (K(l)) {
                    var q = l.toString(); - 1 === q.indexOf("<") && (q = q.replace(/[0-9]/g, "0"));
            ...
            a.prototype.setTextPath = function (b, d) {
                ...
                if (b && d && d.enabled) {
                    ...
                    if (H)
                        for (Q.setAttribute("y", 0), g(e.dx) && Q.setAttribute("x", -e.dx), b = [].slice.call(Q.childNodes), H = 0; H < b.length; H++) {
                            var f = b[H];
                            f.nodeType !== Node.TEXT_NODE && "tspan" !==
                                f.nodeName || N.appendChild(f)
                        }
                    a && l && l.add({
                        element: Q
                    });
            ...
            a.prototype.shadow = function (b, d, g) {
                ...
                if (!l) this.destroyShadows();
                    ...
                    for (r = 1; r <= l.width; r++) {
                        ...
                        g && (q(f, "height", Math.max(q(f, "height") - C, 0)),
                            f.cutHeight = C);
        ...
        return function (h) {
            ...
            f.prototype.updateBoxSize = function () {
                var a = this.text.element.style,
                    e = {},
                    h = this.padding,
                    m = this.bBox = B(this.widthSetting) &&
                    B(this.heightSetting) && !this.textAlign || !G(this.text.textStr) ? f.emptyBBox : this.text.getBBox();
    ...
    L(a, "Core/Renderer/SVG/TextBuilder.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a,
        ...
        return function () {
            ...
            h.prototype.modifyDOM = function () {
                ...
                [].forEach.call(c.element.querySelectorAll("tspan.highcharts-br"), function (f, l) {
                    f.nextSibling && f.previousSibling && (0 === l && 1 === f.previousSibling.nodeType && (c.firstLineMetrics =
                        c.renderer.fontMetrics(void 0, f.previousSibling)), B(f, {
                ...
                if (h) {
                    var m = function (f, l) {
                            ...
                            if (a.ellipsis) q && a.truncate(f, q, void 0, 0, Math.max(0, h - parseInt(a.fontSize || 12, 10)), function (b, d) {
                                ...
                                for (; w.length;) w.length && !a.noWrap && 0 < d && (q.push(f.textContent || ""), f.textContent = w.join(" ").replace(/- /g, "-")), a.truncate(f, void 0, w, 0 === d ? k || 0 : 0, h, function (b, d) {
                ...
                var c =
                    ...
                    e = function (f, h) {
                        var w = f.tagName,
                            ...
                            l = f.attributes || {};
                        if ("b" === w || "strong" === w) q ? l["class"] = "highcharts-strong" : l.style = "font-weight:bold;" + (l.style || "");
                        else if ("i" === w || "em" === w) q ? l["class"] = "highcharts-emphasized" : l.style = "font-style:italic;" + (l.style || "");
            ...
            h.prototype.truncate = function (a, c, e, h, m, w) {
                ...
                if (h + g > m) {
                    for (; z <= p;) d = Math.ceil((z + p) / 2), e && (k = w(e, d)), g = b(d, k && k.length - 1), z === p ? z = p + 1 : g > m ? p = d - 1 : z = d;
        ...
        A = function () {
            ...
            y.prototype.getReferenceURL = function () {
                if ((t || w) && e.getElementsByTagName("base").length) {
                    ...
                    if (aa) return K.location.href.split("#")[0].replace(/<[^>]*>/g, "").replace(/([\('\)])/g,
                        "\\$1").replace(/ /g, "%20")
                }
                return ""
            };
            ...
            y.prototype.button = function (b, d,
                g, k, c, y, l, e, f, F) {
                ...
                H.setState = function (b) {
                    1 !== b && (H.state = N = b);
                    H.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass("highcharts-button-" + ["normal", "hover", "pressed", "disabled"][b ||
                        0
                    ]);
        ...
        return function (a) {
            ...
            m.prototype.setSpanRotation = function (a, c, l) {
                ...
                f && (e[f] = e.transform = "rotate(" +
                    a + "deg)", e[f + (x ? "Origin" : "-origin")] = e.transformOrigin = 100 * c + "% " + l + "px", n(this.element, e))
            };
            return m
        }(u)
    });
        ...
        return {
            registerEventOptions: function (a, u) {
                ...
                G(u.events, function (u, n) {
                    A(u) && a.eventOptions[n] !== u && (A(a.eventOptions[n]) &&
                        x(a, n, a.eventOptions[n]), a.eventOptions[n] = u, v(a, n, u))
                })
            }
        }
    });
    L(a, "Core/Axis/Tick.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u, A) {
        ...
        u = function () {
            ...
            m.prototype.createLabel = function (a, e, l) {
                var f = this.axis,
                    h = f.chart;
                if (a = I(e) && l.enabled ? h.renderer.text(e, a.x, a.y, l.useHTML).add(f.labelGroup) : null) h.styledMode || a.css(c(l.style)),
            ...
            m.prototype.renderLabel = function (a, c, e, h) {
                ...
                a = a.y;
                var r = !0;
                d && f(g) && (d.xy = a = this.getLabelPosition(g, a, d, q, k, l, h, b), this.isFirst && !this.isLast && !p.showFirstLabel || this.isLast && !this.isFirst && !p.showLastLabel ?
                    r = !1 : !q || k.step || k.rotation || c || 0 === e || this.handleOverflow(a), b && h % b && (r = !1), r && f(a.y) ? (a.opacity = e, d[this.isNewLabel ? "attr" : "animate"](a), this.isNewLabel = !1) : (d.attr("y", -9999), this.isNewLabel = !0))
            };
    ...
    L(a, "Core/Axis/Axis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/AxisDefaults.js"], a["Core/Color/Color.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/DefaultOptions.js"], a["Core/Axis/Tick.js"], a["Core/Utilities.js"]], function (a, u, A, G, x, B, I, E, n) {
        ...
        a = function () {
            ...
            a.prototype.init = function (b, a) {
                ...
                a = C(k.crosshair, V(b.options.tooltip.crosshairs)[c ?
                    0 : 1]);
            ...
            a.prototype.setOptions = function (b) {
                this.options = F(u.defaultXAxisOptions, "yAxis" === this.coll && u.defaultYAxisOptions, [u.defaultTopAxisOptions, u.defaultRightAxisOptions,
            ...
            a.prototype.defaultLabelFormatter = function (b) {
                ...
                if (a.categories) var h = "" + this.value;
                    ...
                    for (; f-- &&
                        "undefined" === typeof h;) a = Math.pow(r, f + 1), y >= a && 0 === 10 * d % a && null !== l[f] && 0 !== d && (h = b(d / a, -1) + l[f]);
                ...
                d(this, "getSeriesExtremes", null, function () {
                    ...
                    b.series.forEach(function (d) {
                        if (d.visible || !a.options.chart.ignoreHiddenSeries) {
                            ...
                            } else if (d = d.applyExtremes(), g(d.dataMin) && (e = d.dataMin, b.dataMin = Math.min(C(b.dataMin, e), e)), g(d.dataMax) && (y = d.dataMax, b.dataMax = Math.max(C(b.dataMax,
                                    y), y)), l(r) && (b.threshold = r), !k.softThreshold || b.positiveValuesOnly) b.softThreshold = !1
                        }
                    })
                });
            ...
            a.prototype.translate = function (b, a, d, k, c, r) {
                ...
                a ? (b = (b * f + H - y) / k + l, c && (b = e.lin2val(b))) : (c && (b = e.val2lin(b)),
                    b = g(l) ? f * (b - l) * k + H + f * y + (g(r) ? k * r : 0) : void 0);
                return b
            };
            ...
            a.prototype.getPlotLinePath = function (b) {
                ...
                d(this, "getPlotLinePath", b, function (b) {
                    ...
                    b.path = ea && !M ? null : c.renderer.crispLine([
                        ["M", q, m],
                        ["L", t, n]
                    ], y || 1)
                });
            ...
            a.prototype.getLinearTickPositions = function (b,
                a, d) {
            ...
            a.prototype.getMinorTickPositions = function () {
                ...
                if (c && c / d < this.len / 3) {
                    ...
                    else if (this.dateTime && "auto" === this.getMinorTickInterval()) r = r.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(d), k, g, b.startOfWeek));
                    else
                        for (b = k + (a[0] - k) % d; b <= g && b !== r[0]; b += d) r.push(b)
                }
            ...
            a.prototype.setAxisTranslation = function () {
                ...
                if (c || k || e) {
                    ...
                    g ? (l = g.minPointOffset, f = g.pointRangePadding) : b.series.forEach(function (a) {
                        var d = k ? 1 : c ? C(a.options.pointRange,
            ...
            a.prototype.setTickInterval = function (b) {
                ...
                a.adjustForMinRange();
                !(y || a.axisPointRange ||
                    a.stacking && a.stacking.usePercentage || h) && l(a.min) && l(a.max) && (c = a.max - a.min) && (!l(w) && m && (a.min -= c * m), !l(P) && M && (a.max += c * M));
            ...
            a.prototype.setTickPositions = function () {
                ...
                !g && (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) ? g = this.dateTime ? this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, b.units), this.min, this.max, b.startOfWeek, this.ordinal && this.ordinal.positions, this.closestPointRange, !0) : this.logarithmic ? this.logarithmic.getLogTickPositions(this.tickInterval, this.min,
                    this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max) : (g = [this.min, this.max], z(19, !1, this.chart)), g.length > this.len && (g = [g[0], g.pop()], g[0] === g[1] && (g.length = 1)), this.tickPositions = g, c && (c = c.apply(this, [this.min, this.max]))) && (this.tickPositions = g = c);
            ...
            a.prototype.adjustTickAmount = function () {
                ...
                if (this.hasData() && g(this.min) && g(this.max)) {
                    if (e < k) {
                        for (; d.length < k;) d.length % 2 || this.min === r ? d.push(q(d[d.length - 1] + a)) : d.unshift(q(d[0] - a));
                        this.transA *= (e - 1) / (k - 1);
            ...
            a.prototype.renderUnsquish = function () {
                    ...
                    if (!D) {
                        ...
                        for (f = d.length; !e && f--;) {
                            ...
                            if (q = g[q].label) q.styles && "ellipsis" === q.styles.textOverflow ? q.css({
                                    ...
                                    width: l + "px"
                                }), q.getBBox().height > this.len / d.length -
                                (F.h - F.f) && (q.specificTextOverflow = "ellipsis")
                        }
                    }
                }
                ...
                d.forEach(function (b) {
                    var a = (b = g[b]) && b.label,
                        d = c.width,
                        k = {};
                    a && (a.attr(h), b.shortenLabel ? b.shortenLabel() : p && !d && "nowrap" !== c.whiteSpace && (p < a.textPxLength || "SPAN" === a.element.tagName) ? (k.width = p + "px", D || (k.textOverflow = a.specificTextOverflow || M), a.css(k)) : a.styles && a.styles.width && !k.width &&
                        !d && a.css({
                            width: null
            ...
            a.prototype.getOffset =
                function () {
                    ...
                    }), a.staggerLines && (z *= a.staggerLines), a.labelOffset = z * (a.opposite ? -1 :
                        1)) : M(r, function (b, a) {
                        b.destroy();
                        delete r[a]
                    });
            ...
            a.prototype.getLinePath = function (b) {
                ...
                return a.renderer.crispLine([
                    ...
                    ["L",
                        k ? a.chartWidth - this.right : c, k ? g : a.chartHeight - this.bottom
                    ]
                ], b)
            };
            ...
            a.prototype.render = function () {
                ...
                if (b.hasData() || e) b.minorTickInterval && !b.categories && b.getMinorTickPositions().forEach(function (a) {
                    ...
                    P = "undefined" !== typeof r[g + 1] ? r[g + 1] + q :
                        b.max - q;
                ...
                [f, F, D].forEach(function (b) {
                    ...
                    X(function () {
                        for (var a =
                                d.length; a--;) b[d[a]] && !b[d[a]].isActive && (b[d[a]].destroy(), delete b[d[a]])
            ...
            a.prototype.destroy = function (b) {
                ...
                for (var c in a.plotLinesAndBandsGroups) a.plotLinesAndBandsGroups[c] = a.plotLinesAndBandsGroups[c].destroy();
                M(a, function (b, d) {
            ...
            a.prototype.drawCrosshair = function (b, a) {
                ...
                if (g && !1 !== (l(a) || !k)) {
                    k ? l(a) && (e = C("colorAxis" !== this.coll ? a.crosshairPos : null, this.isXAxis ? a.plotX : this.len -
            ...
            a.prototype.remove = function (b) {
                for (var a = this.chart, d = this.coll, g = this.series, k = g.length; k--;) g[k] && g[k].remove(!1);
                v(a.axes, this);
                v(a[d], this);
        ...
        var v = u.addEvent,
            ...
            I = function () {
                ...
                a.prototype.getLogTickPositions = function (a, h, f, c) {
                    ...
                    if (.5 <= a) a = Math.round(a), n = e.getLinearTickPositions(a, h, f);
                    else if (.08 <= a) {
                        var q = Math.floor(h),
                            l, J = m = void 0;
    ...
    L(a, "Core/Tooltip.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]], function (a, u, A,
        G, x) {
        var v = a.format,
            I = u.doc,
            E = x.clamp,
        ...
        a = function () {
            ...
            a.prototype.defaultFormatter = function (a) {
                ...
                b.push(a.tooltipFooterHeaderFormatter(d[0],
                    !0));
                return b
            };
            a.prototype.destroy = function () {
            ...
            a.prototype.getAnchor = function (a, c) {
                ...
                var k = b.inverted,
                    ...
                    p, m;
                a = J(a);
                this.followPointer && c ? ("undefined" === typeof c.chartX && (c = d.normalize(c)),
                    d = [c.chartX - f, c.chartY - e]) : a[0].tooltipPos ? d = a[0].tooltipPos : (a.forEach(function (a) {
                    p = a.series.yAxis;
                    m = a.series.xAxis;
                    l += a.plotX || 0;
                ...
                if (!this.label) {
                    if (this.outside) {
                        ...
                        n(l, {
                            ...
                            top: "1px",
                            pointerEvents: f,
                            zIndex: Math.max(this.options.style && this.options.style.zIndex ||
                                0, (m && m.zIndex || 0) + 3)
                        });
            ...
            a.prototype.getPosition = function (a, c, b) {
                var d = this.chart,
                    ...
                    m = C ? Math.max(I.body.scrollHeight, I.documentElement.scrollHeight, I.body.offsetHeight, I.documentElement.offsetHeight,
                        I.documentElement.clientHeight) : d.chartHeight,
            ...
            a.prototype.init = function (a, c) {
                ...
                this.outside =
                    l(c.outside, !(!a.scrollablePixelsX && !a.scrollablePixelsY))
            };
            ...
            a.prototype.move = function (a, k, b, g) {
                ...
                d.getLabel().attr(e);
                d.drawTracker();
                f && (x.clearTimeout(this.tooltipTimeout),
            ...
            a.prototype.refresh = function (a, c) {
                ...
                if (d.enabled) {
                    ...
                    if (!1 === a) this.hide();
                        ...
                        else if (k = n, h = w, c && b.pointer.isDirectTouch && (k = c.chartX - b.plotLeft, h = c.chartY - b.plotTop), b.polar || !1 === C.options.clip || C.shouldShowTooltip(k, h)) c = this.getLabel(), d.style.width && !m || c.css({
                ...
                a = a.slice(0, k.length + 1).reduce(function (a, g, c) {
                    if (!1 !== g && "" !== g) {
                        ...
                        r || (r = {
                                padding: x.padding,
                                r: x.borderRadius
                            }, z || (r.fill = x.backgroundColor, r["stroke-width"] = x.borderWidth), r =
                            U.label("", 0, 0, x[h ? "headerShape" : "shape"] || "callout", void 0, void 0, x.useHTML).addClass((h ? "highcharts-tooltip-header " : "") + "highcharts-tooltip-box " + p).attr(r).add(N));
                        r.isActive = !0;
                        r.attr({
                            text: g
                        });
            ...
            a.prototype.drawTracker = function () {
                if (this.followPointer || !this.options.stickOnContact) this.tracker && this.tracker.destroy();
                    ...
                    if (c && b) {
                        ...
                        g.y = Math.min(0, b[1]);
                        g.width =
                            0 > b[0] ? Math.max(Math.abs(b[0]), e.width - b[0]) : Math.max(Math.abs(b[0]), e.width);
    ...
    L(a, "Core/Pointer.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Tooltip.js"], a["Core/Utilities.js"]], function (a, u, A, G, x) {
        ...
        a = function () {
            ...
            a.prototype.drag = function (a) {
                ...
                if (!z || !z.touch)
                    if (w < f ? w = f : w > f + h && (w = f + h), J < l ? J = l : J > l + C && (J = l + C), this.hasDragged = Math.sqrt(Math.pow(p - w, 2) + Math.pow(m - J, 2)), 10 < this.hasDragged) {
            ...
            a.prototype.pinchTranslateDirection = function (a, c, b, g, e, f, l, h) {
                ...
                J ? (v -=
                    .8 * (v - l[k][0]), "number" === typeof z && (z -= .8 * (z - l[k][1])), c()) : l[k] = [v, z];
                D || (f[k] = w - m, f[p] = H);
                f = D ? 1 / N : N;
                e[p] = H;
                e[k] = b;
            ...
            a.prototype.runPointActions = function (d, c) {
                ...
                this.unDocMouseMove || (this.unDocMouseMove = n(b.container.ownerDocument,
                    "mousemove",
                    function (b) {
            ...
            a.prototype.setDOMEvents = function () {
                ...
                this.eventsToUnbind.push(n(c, "mouseleave",
                ...
                for (var g = this.chart.renderTo.parentElement; g && "BODY" !== g.tagName;) this.eventsToUnbind.push(n(g, "scroll", function () {
            ...
            g.prototype.setState = function (b, d) {
                ...
                if (!(b === this.state && !d || this.selected && "select" !== b || !1 ===
                    ...
                    if (this.graphic && !this.hasDummyGraphic) {
                        ...
                        q && (q[b && this.isInside ? "show" : "hide"](), q.element.point =
                            this)
                    }
                    f = f.halo;
    ...
    L(a, "Core/Legend.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function (a, u, A, G, x) {
        ...
        var d = function () {
            ...
            a.prototype.renderItem = function (a) {
                ...
                t || (a.legendGroup = d.g("legend-item").addClass("highcharts-" + n.type + "-series highcharts-color-" + a.colorIndex +
                    (u ? " " + u : "") + (q ? " highcharts-series-" + a.index : "")).attr({
                    zIndex: 1
                    ...
                    Math.max(this.symbolHeight, 16)), w = this.symbolWidth + f + p + (v ? 20 : 0), m && t.attr("x", this.symbolWidth + f))), n.drawLegendSymbol(this, a), this.setItemEvents && this.setItemEvents(a, t, z));
            ...
            a.prototype.adjustMargins = function (a, d) {
                ...
                g && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function (f, k) {
                    f.test(g) && !e(a[k]) && (b[n[k]] = Math.max(b[n[k]], b.legend[(k + 1) % 2 ? "legendHeight" :
            ...
            a.prototype.handleOverflow = function (a) {
                ...
                a && 0 < f && a > f && !1 !== p.enabled ? (this.clipHeight = h = Math.max(f - 20 - this.titleHeight - k, 0), this.currentPage = J(this.currentPage, 1), this.fullHeight =
                    a, z.forEach(function (a, b) {
                        ...
                        c.text("", 15, 10).addClass("highcharts-legend-navigation"), d.styledMode || this.pager.css(p.style), this.pager.add(n), this.down = c.symbol("triangle-down", 0, 0, q, q).add(n), O("downTracker").on("click", function () {
                            b.scroll(1, t)
        ...
        a = function () {
            ...
            a.prototype.isInsidePlot = function (a, b, d) {
                ...
                if (!d.ignoreX) {
                    ...
                    a.isInsidePlot && (c = H && (c ? H.xAxis : H.yAxis) || {
                        pos: f,
                        len: Infinity
            ...
            a.prototype.temporaryDisplay = function (a) {
                var b = this.renderTo;
                if (a)
                    for (; b && b.style;) b.hcOrigStyle && (P(b, b.hcOrigStyle), delete b.hcOrigStyle),
            ...
            a.prototype.addCredits = function (a) {
                ...
                d.enabled && !this.credits && (this.credits = this.renderer.text(d.text + (this.mapCredits || ""), 0, 0).addClass("").on("click", function () {
                ...
                L(this, "pan", {
                    ...
                    b.forEach(function (b) {
                        if (b.options.panningEnabled &&
                            ...
                            b.panningState = N;
                            b.isOrdinal || (r = p - h, 0 < r && (t += r, h = p), r = t - q, 0 < r && (t = q, h -= r), b.series.length && h !== m.min &&
                                t !== m.max && h >= p && t <= q && (b.setExtremes(h, t, !1, !1, {
                                    trigger: "pan"
    ...
    L(a, "Core/Series/Series.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Mixins/LegendSymbol.js"], a["Core/DefaultOptions.js"], a["Core/Color/Palette.js"], a["Core/Series/Point.js"],
        ...
        a = function () {
                ...
                if (!N) {
                    ...
                    if (m && k > m)
                        if (m = e.getFirstValidPoint(a), S(m))
                            for (d = 0; d < k; d++) H[d] = this.autoIncrement(), q[d] = a[d];
                        else if (P(m))
                        if (n)
                            for (d = 0; d < k; d++) c = a[d], H[d] = c[0], q[d] = c.slice(1, n + 1);
                        else
                            for (w && (v = w.indexOf("x"), z = w.indexOf("y"), v = 0 <= v ? v : 0, z = 0 <= z ? z : 1), d = 0; d < k; d++) c = a[d], H[d] = c[v], q[d] = c[z];
                    else r(12, !1, h);
                    else
            ...
            a.prototype.getProcessedData = function (a) {
                ...
                for (k = b.length || 1; --k;)
                    if (c = f ? a(b[k]) - a(b[k - 1]) : b[k] - b[k - 1], 0 < c && ("undefined" === typeof q || c < q)) var q = c;
                    else 0 > c &&
            ...
            a.prototype.drawTracker = function () {
                ...
                l ? l.attr({
                    ...
                    if (a && (a.addClass("highcharts-tracker").on("mouseover",
            ...
            a.prototype.removePoint = function (a, b, d) {
                var e = this,
                    ...
                    l = e.chart,
                    h = function () {
                        k && k.length === g.length && k.splice(a,
                            1);
                        g.splice(a, 1);
            ...
            a.prototype.update = function (a, b) {
                ...
                var c = this,
                    ...
                    m = l[f].prototype,
                    t, q = ["eventOptions", "navigatorSeries", "baseSeries"],
                ...
                a = X(g, n, {
                    ...
                    pointStart: y(k && k.series && k.series.pointStart,
                        g.pointStart, c.xData[0])
                }, !p && {
                    data: c.options.data
                }, a);
            ...
            a.prototype.setState = function (a, b) {
                var d = this,
                    ...
                    l = c.opacity,
                    h = y(f[a || "normal"] &&
                        f[a || "normal"].animation, d.chart.options.chart.animation);
                c = 0;
                a = a || "";
                if (d.state !== a && ([d.group, d.markerGroup, d.dataLabelsGroup].forEach(function (b) {
                    ...
                    if (e && !e.dashstyle)
                        for (f = {
                                "stroke-width": k
                            }, e.animate(f, h); d["zone-graph-" + c];) d["zone-graph-" + c].animate(f, h), c += 1;
            ...
            var v = A.format,
                ...
                w = function () {
                    ...
                    a.prototype.setOffset = function (a, c, f, q, p) {
                        ...
                        c && d && (p = c.getBBox(), q = c.padding, b = "left" === b ? k.inverted ? -q : q : "right" === b ? p.width : k.inverted && "center" === b ? p.width / 2 : k.inverted ? f ? p.width + q : -q : p.width / 2, f = k.inverted ? p.height / 2 : f ? -q : p.height, this.alignOptions.x = m(this.options.x, 0), this.alignOptions.y = m(this.options.y, 0), d.x -= b, d.y -= f, c.align(this.alignOptions,
            ...
            x.prototype.setStackedPoints = function (a) {
                ...
                if (e && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                    ...
                    for (x = 0; x < p; x++) {
                        ...
                        "percent" === e ? (C = C ? a : g, r && u[C] && u[C][A] ? (C = u[C][A], y.total = C.total = Math.max(C.total, y.total) + Math.abs(B) || 0) :
                            y.total = n(y.total + (Math.abs(B) || 0))) : "group" === e ? (c(B) && (B = B[0]), null !== B && (y.total = (y.total || 0) + 1)) : y.total = n(y.total + (B || 0));
            ...
            G = function (x) {
                ...
                n.prototype.getGraphPath = function (a, f, c) {
                    ...
                    a.forEach(function (t, n) {
                        ...
                        t.isNull && !B(f) && 0 < n ? v = !h.connectNulls : t.isNull && !f ? v = !0 : (0 === n || v ? n = [
                                ["M", t.plotX, t.plotY]
                            ] : e.getPointSpline ? n = [e.getPointSpline(a, t, n)] : m ? (n = 1 === m ? [
                                ["L", k.plotX, d]
                            ] : 2 === m ? [
    ...
    L(a, "Series/Spline/SplineSeries.js", [a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, u) {
        var v = this && this.__extends || function () {
                ...
                return function (v, n) {
                    ...
                    a(v, n);
                    v.prototype = null === n ? Object.create(n) : (h.prototype = n.prototype,
                        new h)
                }
            }(),
        ...
        E = function (a) {
            ...
            d.prototype.translate = function () {
                ...
                a.points.forEach(function (b) {
                    ...
                    b.tooltipPos = d.inverted ? [e(l.len +
                        l.pos - d.plotLeft - g, l.pos - d.plotLeft, l.len + l.pos - d.plotLeft), k.len + k.pos - d.plotTop - C - F / 2, y] : [k.left - d.plotLeft + C + F / 2, e(g + l.pos - d.plotTop, l.pos - d.plotTop, l.len + l.pos - d.plotTop), y];
            ...
            d.prototype.pointAttribs = function (a, d) {
                ...
                d && a && (a = K(b.states[d], a.options.states && a.options.states[d] || {}), d = a.brightness, k = a.color || "undefined" !== typeof d && f(k).brighten(a.brightness).get() ||
                    k, l = a[e] || l, h = a[g] || h, c = a.dashStyle || c, p = z(a.opacity, p));
                e = {
                    fill: k,
                    stroke: l,
                    "stroke-width": h,
    ...
    L(a, "Mixins/CenteredSeries.js", [a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Utilities.js"]], function (a, u, A) {
        ...
        return a.CenteredSeriesMixin = {
            getCenter: function () {
                ...
                for (e = 0; 4 > e; ++e) m = a[e], n = 2 > e || 2 === e && /%$/.test(m), a[e] = B(m, [f, c, t, a[2]][e]) + (n ? h : 0);
                a[3] > a[2] && (a[3] = a[2]);
                return a
            },
    ...
    L(a, "Core/Series/DataLabels.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, u, A, G, x, B, I) {
        ...
        x.prototype.drawDataLabels = function () {
            ...
            if (m(h) || h.enabled || e._hasPointLabels) {
                var B =
                    e.plotGroup("dataLabelsGroup", "data-labels", z ? "inherit" : "hidden", h.zIndex || 6);
                B.attr({
                    opacity: +z
                });
        ...
        x.prototype.alignDataLabel = function (a, d, c, b, f) {
            var g = this,
                ...
                x = this.visible && !1 !== a.visible && (a.series.forceDL || m && !w || u || l(c.inside, !!this.options.stacking) && b && k.isInsidePlot(p, h ? b.x + 1 : b.y +
                    b.height - 1, {
                        inverted: h,
                        paneCoordinates: !0,
                        series: g
        ...
        x.prototype.justifyDataLabel = function (a, c, e, b, f, h) {
            ...
            p = (e.y || 0) + b.height - l;
            p > d.plotHeight && ("top" ===
                k && 0 >= n ? (c.verticalAlign = "bottom", c.inside = !0) : n += d.plotHeight - p, q = !0);
        ...
        B.pie && (B.pie.prototype.dataLabelPositioners = {
            ...
            }, B.pie.prototype.alignDataLabel = a, B.pie.prototype.verifyDataLabelOverflow =
            function (a) {
                var c = this.center,
                    e = this.options,
                    b = e.center,
                        ...
                        function c(a, f, h, m) {
                            ...
                            I(a, function (a, d) {
                                if (!m && -1 < e.collectionsWithUpdate.indexOf(d) && f[d])
                                    for (a = n(a), h[d] = [], l = 0; l < Math.max(a.length, f[d].length); l++) f[d][l] && (void 0 === a[l] ? h[d][l] = f[d][l] : (h[d][l] = {}, c(a[l], f[d][l], h[d][l], m + 1)));
